...
Game.prototype = {
  ...
  _createJumper: function() {
    ...
    var geometry = new THREE.CylinderBufferGeometry(this.config.jumperWidth,this.config.jumperR,this.config.jumperHeight,this.config.jumperF)
  ...
  _setLight: function() {
    ...
    directionalLight.position.set(26, 20, 10);
